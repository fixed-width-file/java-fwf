...
public class TestHydrating {
    ...
    void testHydrateDehydrateCharColumn() {
        ...
        assertEquals("com.kelsoncm.fwf.columns.CharColumn", map.get("_hydrate_as"));
    ...
    void testHydrateDehydrateEdgeCases() {
        ...
        customMap.put("_hydrate_as", "com.kelsoncm.fwf.columns.CharColumn");
        ...
        nestedMap.put("_hydrate_as", "com.kelsoncm.fwf.descriptors.FileDescriptor");
        nestedMap.put("args", List.of(List.of(Map.of(
                "_hydrate_as", "com.kelsoncm.fwf.descriptors.DetailRowDescriptor",
                "args", List.of(List.of(Map.of(
                        "_hydrate_as", "com.kelsoncm.fwf.columns.PositiveDecimalColumn",
        ...
        Map<String, Object> simpleArgMap = Map.of(
                "_hydrate_as", "com.kelsoncm.fwf.columns.PositiveIntegerColumn",
        ...
        badAttrMap.put("_hydrate_as", "com.kelsoncm.fwf.columns.CharColumn");
        ...
        Map<String, Object> badCtorMap = Map.of(
                "_hydrate_as", "com.kelsoncm.fwf.columns.CharColumn",
