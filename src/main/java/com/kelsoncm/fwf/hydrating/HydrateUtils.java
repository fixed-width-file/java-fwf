package com.kelsoncm.fwf.hydrating;
...
public final class HydrateUtils {
    ...
    /**
     * Map Python class names to Java class names for cross-language compatibility.
     */
    private static final Map<String, String> CLASS_NAME_MAPPING = Map.ofEntries(
            Map.entry("pyfwf.columns.CharColumn", "com.kelsoncm.fwf.columns.CharColumn"),
            Map.entry("pyfwf.columns.RightCharColumn", "com.kelsoncm.fwf.columns.RightCharColumn"),
            Map.entry("pyfwf.columns.PositiveIntegerColumn", "com.kelsoncm.fwf.columns.PositiveIntegerColumn"),
            Map.entry("pyfwf.columns.PositiveDecimalColumn", "com.kelsoncm.fwf.columns.PositiveDecimalColumn"),
            Map.entry("pyfwf.columns.DateTimeColumn", "com.kelsoncm.fwf.columns.DateTimeColumn"),
            Map.entry("pyfwf.columns.DateColumn", "com.kelsoncm.fwf.columns.DateColumn"),
            Map.entry("pyfwf.columns.TimeColumn", "com.kelsoncm.fwf.columns.TimeColumn"),
            Map.entry("pyfwf.descriptors.HeaderRowDescriptor", "com.kelsoncm.fwf.descriptors.HeaderRowDescriptor"),
            Map.entry("pyfwf.descriptors.DetailRowDescriptor", "com.kelsoncm.fwf.descriptors.DetailRowDescriptor"),
            Map.entry("pyfwf.descriptors.FooterRowDescriptor", "com.kelsoncm.fwf.descriptors.FooterRowDescriptor"),
            Map.entry("pyfwf.descriptors.FileDescriptor", "com.kelsoncm.fwf.descriptors.FileDescriptor")
    );
